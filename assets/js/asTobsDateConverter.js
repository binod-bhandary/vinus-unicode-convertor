...
//var getNepaliNumber = require('./translate-func.js');
...
var defaults = {
  ...
  npdaysName = ["आईतबार", "सोमबार", "मंगलबार", "बुधबार", "बिहीबार", "शुक्रबार", "शनिबार"],
  npdaysShortName = ["आईत", "सोम", "मंगल", "बुध", "बिही", "शुक्र", "शनि"],
  npdaysMinName = ["आ", "सो", "मं", "बु", "बि", "शु", "श"],
  engDaysName = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
  engDaysShortName = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
  engDaysMinName = ['Su', 'M', 'T', 'W', 'T', 'F', 'Sa'],
...
function countADDays(date) {
  ...
  var date2 = new Date(dateObj.year + "/" + dateObj.month + "/" + dateObj.day + TZ);
...
function offsetBSDays(dayData) {
  ...
  // var npDayOfWeek = npdaysName(dayOfWeek),
  //     enDayOfWeek = getNepDayOfWeek(dayOfWeek, {
  //       'lang': 'en'
  //     });

  var totalDays = calendar_data[bs_date.year][bs_date.month - 1]
  var dateObj = {
    result: getNepaliNumber(bs_date.year)+'-'+getNepaliNumber(bs_date.month)+'-'+getNepaliNumber(bs_date.day),
    ne: {
      fullDate: getNepaliNumber(bs_date.year)+'-'+getNepaliNumber(bs_date.month)+'-'+getNepaliNumber(bs_date.day),
      ...
      strDayOfWeek: npdaysName[dayOfWeek],
      strShortDayOfWeek: npdaysShortName[dayOfWeek],
      strMinDayOfWeek: npdaysMinName[dayOfWeek],
      totalDaysInMonth: getNepaliNumber(totalDays)
    },
    en: {
      fullDate:  bs_date.year+'-'+bs_date.month+'-'+bs_date.day,
      year: bs_date.year,
      month: bs_date.month,
      day: bs_date.day,
      ...
      strMinDayOfWeek: engDaysMinName[dayOfWeek],
